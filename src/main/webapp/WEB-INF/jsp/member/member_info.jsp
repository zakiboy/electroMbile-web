        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          ...
          <form class="am-form am-form-horizontal" action="${ctx }/member/queryMemberList" method="post">
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="memberName" readonly="readonly" value="${member.memberName }"/>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="memberOpenId" value="${member.memberOpenId }" readonly="readonly"/>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="memberPhone" value="${member.memberPhone }" readonly="readonly" />
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="memberBirthday" value="${member.memberBirthday }" readonly="readonly" />
              </div>
            </div>
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
                <button type="submit" class="am-btn am-btn-primary">返回</button>
              </div>
            </div>
          </form>
