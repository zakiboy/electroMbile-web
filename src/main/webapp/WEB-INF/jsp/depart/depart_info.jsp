        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form action="${ctx}/depart/addDepartInfo" class="form-horizontal" method="post">
         	...
         	<div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="departmentName" value="${depart.departmentName }" readonly="readonly" />
              </div>
            </div>
         	...
         	<div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="departmentNo" value="${depart.departmentNo }" readonly="readonly" />
              </div>
            </div>
