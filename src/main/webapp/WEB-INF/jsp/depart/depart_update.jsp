        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form action="${ctx}/depart/addDepartInfo" class="form-horizontal" method="post">
         	...
         	<div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="departmentName" value="${depart.departmentName }" />
              </div>
            </div>
         	...
         	<div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="departmentNo" value="${depart.departmentNo }" />
              </div>
            </div>
            
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">部门状态</label>
              <div class="am-u-sm-9">
                   <c:choose>
                  	...
                  	<c:otherwise>
                  		<input type="radio" name="departmentStatus" value="0">有效</input>
                  		<input type="radio" name="departmentStatus" value="1" checked="checked">无效</input>
                  	</c:otherwise>
                  </c:choose>
              </div>
            </div>
